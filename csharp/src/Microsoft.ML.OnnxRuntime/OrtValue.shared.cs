...
namespace Microsoft.ML.OnnxRuntime
{
    ...
    public class OrtValue : SafeHandle
    {
        ...
        public string GetStringElement(int index)
        {
            ...
            unsafe
            {
                return Encoding.UTF8.GetString((byte*)(buffer).ToPointer(), (int)len);
            }
        }
        ...
        /// <summary>
        /// Creates an OrtValue that contains a string tensor of specified shape.
        ...
        public static OrtValue CreateTensorWithEmptyStrings(long[] shape)
        {
        ...
        public static OrtValue CreateStringTensor(Tensor<string> tensor)
        {
            ...
            var ortValue = CreateTensorWithEmptyStrings(shape);
            try
            {
        ...
        /// 
        /// All OrtValues are internally refcounted and stored within the sequence OrtValue
